...
Το  συγκεκριμένο μηχάνημα θα χρησιμοποιηθεί από πολλούς ανθρώπους στο μέλλον για την πρόγνωση της καθαριότητας του αέρα .Επίσης θα μπορούσαμε να βάλουμε περισσοτερους αισθιτήρες και μια εφαρμογή για κινητά ωστε αν οαέρας είναι πολύ χαλια να βγάζει μια ειδοποίηση. 
