...
Το  συγκεκριμένο μηχάνημα θα χρησιμοποιηθεί από πολλούς ανθρώπους στο μέλλον για την πρόγνωση της καθαριότητας του αέρα .Επίσης θα μπορούσαμε να συνδέσουμε  περισσοτερους αισθητήρες πάνω στην πλατφόρμα  και να δημιούργήσουμε μια εφαρμογή για smart phones ωστε αν ο αέρας είναι χαμηλής ποιότητας να στέλνει μια ειδοποίηση. 
